...
//TODO: why am I not getting an erro if I don't define the -DSECP macro?
...
int main() {
    ...
    printf("Trying out field elements of libsecp256k1\n");
    unsigned char fea[32];
    secp256k1_fe a = SECP256K1_FE_CONST(0, 0, 0, 0, 0, 0, 0, 1);
    secp256k1_fe_get_b32(fea, &a);
    print_buf(fea, 32);
